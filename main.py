...
player1 = Player(300, 150, RED, py.K_a, py.K_d, py.K_SPACE, py.K_LCTRL, py.K_e, 'L')
player2 = Player(800, 150, BLUE, py.K_LEFT, py.K_RIGHT, py.K_RCTRL, py.K_KP0, py.K_KP1, 'R')
