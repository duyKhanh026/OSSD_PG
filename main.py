...
player1 = Player(300, 350, RED, py.K_a, py.K_d, py.K_SPACE, py.K_LCTRL, 'L')
player2 = Player(800, 350, BLUE, py.K_LEFT, py.K_RIGHT, py.K_RCTRL, py.K_KP0, 'R')
...
while run:
	...
	for player in [player1, player2]:
		...
		player.punch(py.key.get_pressed())
